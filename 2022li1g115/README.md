...
```bash
$ git clone git@gitlab.com:uminho-di/li1/2223/2022li1g115.git
$ cd 2022li1g115
```
...
```bash
$ git clone https://gitlab.com/uminho-di/li1/2223/projetos/2022li1g115.git
$ cd 2022li1g115
```
...
- **A104619** Gonçalo Carmo;
- **A104539** João Ferreira;
